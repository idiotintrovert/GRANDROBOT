...
PM_START_TEXT = """
**Hello {}, My Name is {jackdawson}!** 
I am an **awesome** multipurpose bot , made for fum
...
Hello! my name is *{Jack Dawson}*.made for managing groups
...
TECHNO_IMG = "https://telegra.ph/file/329bf352af4542a4a8f30.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                TECHNO_IMG,
                PM_START_TEXT.format(escape_markdown(first_name), escape_markdown(bot.first_name), 1475369169),
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       callback_data="help_back".format(bot.username)),
                                                                                   InlineKeyboardButton(text="My Father🧑‍💻",
                                                                       url="t.me/Notatalkative")],
                                                                                   [InlineKeyboardButton(text="ADD Jack TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code🪂",
                                                                       url="https://github.com/idiotintrovert/GRANDROBOT/tree/master/tg_bot")
                                                                                 ]]))
